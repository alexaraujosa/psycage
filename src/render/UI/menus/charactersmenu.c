...
void draw_CharactersMenu(Menu menu) {
    ...
    mvwprintw(
        menu->wnd, 
        yMAX/3, xMAX/2 - 
        strlen(get_localized_string(g_renderstate->language, "menu.characters.choose"))/2 + 1, 
        "%s", get_localized_string(g_renderstate->language, "menu.characters.choose")
    );
    ...
    rectangle(
        ...
        yMAX/3 + ESPACAMENTO_CHARACTERS + BOTOES_CHARACTERS*2, 
        xMAX/2 + tamanho_Botao_Maior/2 + (g_renderstate->language == EN_US ? 1 : 0)
    );
...
void draw_CharactersInfo(Menu menu){
    static char *info[] = {
        "menu.characters.info.priest.one", "menu.characters.info.priest.two", "menu.characters.info.priest.three", 
        "menu.characters.info.priest.four", "menu.characters.info.priest.five", "menu.characters.info.priest.six",
        "menu.characters.info.detective.one", "menu.characters.info.detective.two", "menu.characters.info.detective.three", 
        "menu.characters.info.detective.four", "menu.characters.info.detective.five", "menu.characters.info.detective.six", 
        "menu.characters.info.mercenary.one", "menu.characters.info.mercenary.two", "menu.characters.info.mercenary.three", 
        "menu.characters.info.mercenary.four", "menu.characters.info.mercenary.five", "menu.characters.info.mercenary.six", 
    };
